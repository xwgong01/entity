...
RUNDIR=/travail/xgong/testmpi #_mpi
mkdir -p ${RUNDIR}
cd ${RUNDIR}
...
mpiexec -np N ${RUNDIR}/../../../obs/xgong/entity/build_mpi/src/entity.xc -input ${RUNDIR}/../../../obs/xgong/entity/pgens/mcp/testmpi.toml #-restart
